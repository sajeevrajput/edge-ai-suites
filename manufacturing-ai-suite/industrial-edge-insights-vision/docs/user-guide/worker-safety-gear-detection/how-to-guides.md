...
This section collects guides for Worker Safety Gear Detection sample application.
...
- [Deploy multiple instances using Helm charts](./how-to-guides/deploy-multiple-instances-with-helm.md)
