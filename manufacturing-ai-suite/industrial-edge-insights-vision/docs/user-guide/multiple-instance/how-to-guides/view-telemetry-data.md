...
- Open `https://<HOST_IP>:<NGINX_HTTPS_PORT>/prometheus` in your browser to view the prometheus console and try out the below queries:
  ...
  - `fps_per_pipeline{}`
    ...
    ![Open telemetry fps_per_pipeline example in prometheus](../_assets/prometheus.png)
