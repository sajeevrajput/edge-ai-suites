...
8. Modify the payload in `helm/apps/pcb-anomaly-detection/payload.json` to launch an instance for the mlops pipeline with this new model
   ...
   [
       {
           ...
           "payload":{
               ...
               "parameters": {
                   "classification-properties": {
                       "model": "/home/pipeline-server/resources/models/deployment/Anomaly classification/model/model.xml",
                       "device": "CPU"
                   }
               }
           }
