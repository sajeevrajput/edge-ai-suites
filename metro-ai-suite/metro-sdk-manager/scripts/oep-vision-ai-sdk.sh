...
#######################################
# OEP Vision AI SDK System Resource Checker and Installation Script
...
images=(
  ...
  "intel/scenescape-manager:v2026.1.0-rc1"
  "intel/scenescape-controller:v2026.1.0-rc1"
  "intel/scenescape-autocalibration:v2026.1.0-rc1"
)
